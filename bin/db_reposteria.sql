...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-08-2014 a las 19:25:42
...
INSERT INTO `t00_estados` (`id_estado`, `cod_estado`, `desc_estado`, `f_creacion`, `programa`, `id_grupo`) VALUES
(1, 'EP001', 'Con Vida', '2014-08-09', 'MANUAL', 4),
(2, 'EP002', 'Difunto', '2014-08-09', 'MANUAL', 4),
(3, 'EP003', 'Vejes', '2014-08-09', 'MANUAL', 4),
(4, 'EP004', 'Discapasitado', '2014-08-09', 'MANUAL', 4),
(5, 'EP005', 'Convaleciente', '2014-08-09', 'MANUAL', 4),
(6, 'EU001', 'Acitvo', '2014-08-09', 'MANUAL', 5),
(7, 'EU002', 'Inactivo', '2014-08-09', 'MANUAL', 5);
...
CREATE TABLE IF NOT EXISTS `t00_estantes` (
  ...
  `cod_estante` varchar(5) NOT NULL,
...
(1, 'GRU01', 'Tipos de Usuarios', '2014-07-05', 'MANUAL'),
(2, 'GPR01', 'Tipos de Productos', '2014-07-05', 'MANUAL'),
(3, 'GPE01', 'Grupos de Personas', '2014-08-09', 'MANUAL'),
(4, 'GEP01', 'Grupo de Estado de Personas', '2014-08-09', 'MANUAL'),
(5, 'GEU01', 'Grupo de Estado de Usuarios', '2014-08-09', 'MANUAL');
...
CREATE TABLE IF NOT EXISTS `t00_localidades` (
  ...
  `referencia_localidad` varchar(150) NOT NULL,
  `acceso_localidad` varchar(150) NOT NULL,
  `id_munic` int(3) NOT NULL,
  `bloque` varchar(3) NOT NULL,
  `peatonal` varchar(3) NOT NULL,
...
INSERT INTO `t00_personas` (`id_persona`, `cod_persona`, `id_tipo_persona`, `id_sexo`, `id_estado_civil`, `id_munic`, `id_estado`, `f_creacion`, `programa`, `no_identidad`, `nombre_1`, `nombre_2`, `apellido_1`, `apellido_2`, `f_nacimiento`, `telefono`, `celular`, `direccion`, `e_mail`, `skype`, `facebook`, `rtn`, `no_pasaporte`) VALUES
(1, 'PE001', 2, 1, 2, 110, 1, '2014-08-09', 'Manual', '0801198520207', 'Nahum', 'Aaron', 'Martinez', 'Salgado', '1985-04-03', 22058495, 88907234, 'Colonia Centro America Oeste, Bloque G, casa 1221', 'neroblanco22@yhaoo.es', 'neroblanco22', 'Nahum Martinez', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `t00_sucursales` (
  ...
  `referencia_sucursal` varchar(150) NOT NULL,
...
INSERT INTO `t00_tipos` (`id_tipo`, `id_grupo`, `cod_tipo`, `desc_tipo`, `f_creacion`, `programa`, `observaciones`) VALUES
(1, 1, 'TU001', 'Administrador', '2014-07-06', 'MANUAL', 'Usuario con Todos los Privilegios del Sistema'),
(2, 3, 'TP001', 'Natural', '2014-08-09', 'MANUAL', 'Persona Natural'),
(3, 3, 'TP002', 'Juridica', '2014-08-09', 'MANUAL', 'Persona Juridica');
