...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-11-2014 a las 06:58:36
...
(1, 'ALM001', '2014-10-26', 't00_TiposProd', 'Almacen Principal', 'nahum', 5, 1, 1),
...
INSERT INTO `t00_categorias` (`id_categoria`, `cod_categoria`, `desc_categoria`, `f_creacion`, `programa`, `usuario`) VALUES
(1, 'CAP00', 'Categoria Num 1', '2014-11-01', 't00_Categorias', 'nahum');
...
(5, 'CCL005', 2, '2014-11-02', 't00_TiposProd', 'nahum', 10, 6);
...
CREATE TABLE IF NOT EXISTS `t00_descuentos` (
  ...
  `monto_descuneto` double NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t00_medidas` (
  ...
  `cod_medida` int(5) NOT NULL,
  `desc_medida` int(30) NOT NULL,
...
(3, 'PER003', 2, 2, 4, 1, 1, '2014-10-31', 't00_Personas', 'nahum', '0801198612134', 'Eva', 'Maria', 'Barahona', 'Mira', '1986-07-12', 22058495, 89009933, 'Altos del Trapiche, calle Principal subiendo por el palito tercera casa, enfrente de casa de tres plantas color azul', 'evamariab86@yahoo.es', 'eva maria', 'Eva Barahona', '', '', ''),
(14, '1986', 2, 2, 1, 19, 1, '2014-11-06', 't00_Personas', 'nahum', '0801198854376', 'Eva', 'petronila', 'LOpez', 'Castro', '1988-02-14', 22273398, 99356900, 'col.la peÃ±a por bajo , una cuadra arriba de la estacion de buses del popular ', 'evapetroloca@yahoo.es', '', '', '', '5555555555', '');
...
CREATE TABLE IF NOT EXISTS `t00_productos` (
  ...
  `altura_cm` varchar(6) NOT NULL,
  `ancho_cm` varchar(6) NOT NULL,
  `peso_lb` varchar(6) NOT NULL,
...
INSERT INTO `t00_tipos` (`id_tipo`, `id_grupo`, `cod_tipo`, `desc_tipo`, `f_creacion`, `programa`, `observaciones`, `usuario`) VALUES
(1, 1, 'TTU001', 'Administrador', '2014-07-06', 'MANUAL', 'Usuario con Todos los Privilegios del Sistema', NULL),
(2, 3, 'TPP001', 'Natural', '2014-08-09', 'MANUAL', 'Persona Natural', NULL),
(3, 3, 'TPP002', 'Juridica', '2014-08-09', 'MANUAL', 'Persona Juridica', NULL),
(4, 6, 'TLO001', 'Colonias', '2014-10-25', 't00_Tipos', 'Tipo de Localidades de Colonias', NULL),
(5, 6, 'TLO002', 'Residenciales', '2014-10-25', 't00_Tipos', 'Tipo de Localidades de Residenciales', NULL),
(6, 6, 'TLO003', 'Barrios', '2014-10-25', 't00_Tipos', 'Tipo de Localidades Aldeas', NULL),
(7, 6, 'TLO004', 'Aldeas', '2014-10-25', 't00_Tipos', 'Tipo de Localidades Aldeas', NULL),
(8, 7, 'TEP001', 'Permanentes', '2014-10-25', 't00_Tipos', 'Tipos de Empleados Permanentes', NULL),
(9, 7, 'TEP002', 'Temporal', '2014-10-25', 't00_Tipos', 'Tipos de Empleados Temporales', NULL),
(10, 8, 'TTC001', 'Normal', '2014-10-30', 't00_Tipos', 'Tipos de Clientes Normales', NULL),
(11, 8, 'TTC002', 'Especial', '2014-10-30', 't00_tipos', 'Tipos de Clientes Especiales', NULL),
(12, 8, 'TTC003', 'Gubernamental', '2014-10-30', 't00_Tipos', 'Tipos de Clientes Gubernamentales', NULL),
(13, 8, 'TTC004', 'Tercera Edad', '2014-10-30', 't00_Tipos', 'Tipos de Clientes Tercera Edad', NULL),
(14, 9, 'TTP001', 'Bienes', '2014-11-03', 't00_Tipos', 'Tipos de Proveedore de Bienes', 'Admin'),
(15, 9, 'TTP002', 'Servicios', '2014-11-03', 't00_Tipos', 'Tipos de Proveedores de Servicios', 'Admin'),
(16, 9, 'TTP003', 'Recursos', '2014-11-03', 't00_Tipos', 'Tipos de Proveedores de Recursos', 'Admin');
