...
<html>
    <head>
        ...
        <script src="v_valid_Almacenes.js"></script>
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="#"><i class="fa fa-angle-double-right"></i> Almacenes</a></li>
            ...
            <aside class="right-side">
                ...
                <section class="content" id="content">
                    ...
                    <div class='box box-info'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Consulta de Almacenes <small>Filtro para buscar Almacenes</small></h3>
                                    <!-- tools box -->
                    ...
                    <!-- NMA : FIN -->            
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <?php include_once("../../../ctrl/ctrlAlmacenes/ctrlTablaAlmacenes.php"); 
											CTablaAlmacenes();
										?>
                                    </table>
                            </div><!-- /.box -->
					 <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Ingreso de Almacenes <small>Formulario para Ingreso de Almacenes</small></h3>
                                    
                                    
                                </div><!-- /.box-header -->
                                
                                    
                <!-- Inicio de Creaion de Formulario de Almacenes
                NMA : 05-10-2014 -->
                						
                <!-- Creacion del Formulario de Almacenes -->
                ...
                <legend style="color:#000; border-color:#000"></legend>
                        ...
                        <form method="post" action="#" name="form_Almacenes" id="form_Almacenes" >
                        	<table>
                            	<tr>
                                	<td><label>Codigo :</label></td>
                                	<td><input class="cod" id="cod_alm" name="cod_alm" type="text" placeholder="Codigo"  maxlength="6" onkeyup="Upper(cod_alm);" ></td>
                                </tr>
                            	<tr>
                                	<td><label>Descripcion :</label></td>
                                	<td><input class="desc" id="desc_alm" name="desc_alm" type="text" placeholder="Introduzca la Descripcion" disabled></td>
                                </tr>
                            	<tr>
								...
								<tr>
                                	...
                                	<td><SELECT class="combo" name="id_sucursal"  id="id_sucursal" disabled>
										<option value="0">Seleccione una Opción...</option>
											<?php 
											 include_once("../../../scripts/scr_cargarCombo.php");	
											 CCombo('t00_sucursales','id_sucursal','nombre_sucursal','cod_sucursal','%%');
											?>
										</SELECT></td>
                                </tr>
								<tr>
								...
								<tr>
                                	<td><label>Num. Estantes :</label></td>
                                	<td><input class="num" id="num_estantes" name="num_estantes" type="text" placeholder="Numero de Estantes" disabled maxlength="3" ></td>
                                </tr>
                            </table>
                            <table>    
                                <tr>
                ...
                <!-- Final de Creaion de Formulario de Almacenes
                NMA : 14-09-2014 -->
                                </div><!-- /.box-body -->
        ...
        <script src="v_ajax_Almacenes.js"></script>
    </body>
</html>
