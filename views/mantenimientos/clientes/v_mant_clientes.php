    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="left-side sidebar-offcanvas">
				...
				<li class="active"><a href="#"><i class="fa fa-angle-double-right"></i> Clientes</a></li>
            ...
            <aside class="right-side">
                ...
                <!-- Inicio de Creaion de Formulario de Clientes
                NMA : 01-11-2014 -->
                						
                <!-- Creacion del Formulario de Clientes -->
                ...
                <legend style="color:#000; border-color:#000"></legend>
                        ...
                        <form method="post" action="#" name="form_Clientes" id="form_Clientes" >
							...
							<marquee width="100%" height="30" align="bottom">
								...
								<tr>
                                	<td><label class="td_1">Codigo :</label></td>
                                	<td><input class="cod" id="cod_pers" name="cod_pers" type="text" placeholder="Codigo"  maxlength="6" onkeyup="Upper(cod_pers);" disabled><input class="btn btn-warning" type="button" value="Buscar" id="botonbc" name="btnbuscac" accesskey="bs" onclick='BuscarCli();' disabled></td>
