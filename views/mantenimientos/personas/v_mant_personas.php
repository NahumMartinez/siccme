...
<html>
    <head>
        ...
        <script src="v_valid_Personas.js"></script>
		<!-- Jquery UI -->
    ...
    <body class="skin-blue" >
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content" id="content">
                    ...
                    <div class='box box-info'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Consulta de Personas <small>Filtro para buscar Personas </small></h3>
                                    <!-- tools box -->
                    ...
                    <!-- NMA : FIN -->            
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        <?php include_once("../../../ctrl/ctrlPersonas/ctrlTablaPersonas.php"); 
											CTablaPersonas();
										?>
                                    </table>
                            </div><!-- /.box -->
					 <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Ingreso de Personas <small>Formulario para Ingreso de Personas</small></h3>
                ...
                <legend style="color:#000; border-color:#000"></legend>
                        ...
                        <form method="post" action="#" name="form_Personas" id="form_Categorias" >
                        	<table> <!-- Primera Tabla Datos de Sistemas -->
                            	<tr>
                                	<td><label class="td_1">Codigo :</label></td>
                                	<td><input class="cod" id="cod_persona" name="cod_persona" type="text" placeholder="Codigo"  maxlength="6" onkeyup="Upper(cod_persona);" ></td>
                                </tr>
                            	...
                            	<tr>
                                    ...
                                    <td><input type="hidden" value="t00_Personas" name="programa" id="programa"></td>
                                </tr>
							</table>
							<hr>
							...
							<table> <!-- Tercera Tabla Datos Personales -->
								<tr>
                                	...
                                	<td><input class="desc" id="num_identidad" name="num_identidad" type="text" placeholder="Numero de Identidad" maxlength="13" disabled></td>
								</tr>
								
								<tr>
                                	<td ><label class="td_1">No. R.T.N. :</label></td>
                                	<td><input class="desc" id="num_rtn" name="num_rtn" type="text" placeholder="Numero de RTN" disabled maxlength="14"></td>
									
									<td ><label class="td_1">No. Pasaporte :</label></td>
                                	<td><input class="desc" id="num_pas" name="num_pas" type="text" placeholder="Numero de Pasaporte" disabled maxlength="10"></td>
								</tr>
								
								<tr>
                                	<td ><label class="td_1">Primer Nombre :</label></td>
                                	<td><input class="desc" id="nombre_1" name="nombre_1" type="text" placeholder="Primer Nombre" disabled maxlength="15"></td>
									
									<td ><label class="td_1">Segundo Nombre :</label></td>
                                	<td><input class="desc" id="nombre_2" name="nombre_2" type="text" placeholder="Segundo Nombre" disabled maxlength="15"></td>
								</tr>
								
								<tr>
                                	<td ><label class="td_1">Primer Apellido :</label></td>
                                	<td><input class="desc" id="apellido_1" name="apellido_1" type="text" placeholder="Primer Apellido" disabled maxlength="15"></td>
									
									<td ><label class="td_1">Segundo Apellido :</label></td>
                                	<td><input class="desc" id="apellido_2" name="apellido_2" type="text" placeholder="Segundo Apellido" disabled maxlength="15"></td>
								</tr>
								
								<tr>
                                	<td ><label class="td_1">Telefono :</label></td>
                                	<td><input class="num" id="telefono" name="telefono" type="text" placeholder="Telefono" disabled maxlength="8"></td>
									
									<td ><label class="td_1">Celular :</label></td>
                                	<td><input class="num" id="celular" name="celular" type="text" placeholder="Celular" disabled maxlength="8"></td>
								</tr>
							</table>
							<hr >
        ...
        <script src="v_ajax_Personas.js"></script>
    </body>
</html>
