...
var f = document.form_Personas;
	if(f[0].value =='')
	{
		...
		f[0].focus();
				...
				return;
			}else if(f.nombre_1.value == ''){
				alert('Falta Ingresar el Primer Nombre, para continuar');
				f.nombre_1.focus();
				return;
			}else if(f.apellido_1.value == ''){
				alert('Falta Ingresar el Primer Apellido, para continuar');
				f.apellido_1.focus();
				return;
			}else if(f.telefono.value == ''){
				alert('Falta Ingresar el Telefono, para continuar');
				f.telefono.focus();
				return;
			}
	else{
...
function Eliminar(){
			var f = document.form_Personas;
			if(confirm('Desea Eliminar esta Persona de Forma Definitiva?'))
			{
				if(f[0].value == '') 
				{
					alert('Falta Ingresar el Codigo para continuar');
