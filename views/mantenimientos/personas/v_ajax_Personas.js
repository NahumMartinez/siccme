			...
			type: "POST",
              ...
              success: function(response) {
					...
					setTimeout(function () 
				{
					...
					$("#id_cond_fiscal").val(response.valor21);
					$("#f_nacimiento").val(response.valor22);
			...
			type: "POST",
              ...
              success: function(response) {
				...
				// Reiniciamos el Fomulario 
                                $(location).attr('href',"v_mant_personas.php");
					}, 2000);
				});
