...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Mantenimiento | Tipos de Productos</title>
        ...
        <script src="v_valid_TiposProductos.js"></script>
            ...
            <aside class="left-side sidebar-offcanvas">
				...
				<li><a href="../proveedores/v_mant_proveedores.php"><i class="fa fa-angle-double-right"></i> Proveedores</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                            	<li><a href="../ingreso_productos/v_mant_ingresoproductos.php"><i class="fa fa-angle-double-right"></i> Ingreso de Compras</a></li>
                ...
                <section class="content" id="content">
                    ...
                    <div class='box box-info'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Consulta de Tipos de Productos <small>Filtro para buscar Tipos de Productos</small></h3>
                                    <!-- tools box -->
                    ...
                    <!-- NMA : FIN -->            
					 ...
					 <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Ingreso de Tipos de Productos <small>Formulario para Ingreso de Tipos de Productos</small></h3>
