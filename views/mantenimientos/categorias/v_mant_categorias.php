...
<html>
    <head>
        ...
        <script src="v_valid_Categoria.js"></script>
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="#"><i class="fa fa-angle-double-right"></i> Categorias de Productos</a></li>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Mantenimientos  
                        <small>Categorias de Productos</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
                        <li><a href="#">Mantenimientos</a></li>
                        <li class="active">Categorias de Productos</li>
                    </ol>
                </section>
                ...
                <section class="content" id="content">
                    ...
                    <div class='box box-info'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Consulta de Categorias <small>Filtro para buscar categorias</small></h3>
                                    <!-- tools box -->
                    ...
                    <!-- NMA : FIN -->            
                                ...
                                <!-- NMA : INI Tabla -->
                                <?php include_once("../../../ctrl/ctrlCategorias/ctrlTablaCategorias.php");	?>
                                <!-- NMA : FIN Tabla -->                        
					 <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Ingreso de Categorias</h3>
                                    
                                </div><!-- /.box-header -->
                                
                                    
                <!-- Inicio de Creaion de Formulario de Categorias
                NMA : 14-09-2014 -->
                						
                <!-- Creacion del Formulario de Categorias -->
                ...
                <legend style="color:#000; border-color:#000"></legend>
                        ...
                        <form method="post" action="#" name="form_Categorias" id="form_Categorias" >
                        	<table>
                            	<tr>
                                	<td><label>Codigo :</label></td>
                                	<td><input class="cod" id="cod_cat" name="cod_cat" type="text" placeholder="Codigo"  maxlength="6" onkeyup="Upper(cod_cat);" ></td>
                                </tr>
                            	<tr>
                                	<td><label>Descripcion :</label></td>
                                	<td><input class="desc" id="desc_cat" name="desc_cat" type="text" placeholder="Introduzca la Descripcion" disabled></td>
                                </tr>
                            	<tr>
                            	...
                            	<tr>
                                    ...
                                    <td><input type="hidden" value="t00_Categorias" name="programa" id="programa"></td>
                                </tr>
                            </table>
                            <table>    
                                <tr>
                                	<td><input class="btn btn-warning" type="button" value="Nuevo" id="boton" name="btnincluir" onclick='Incluir();' ></td>
        ...
        <script src="v_ajax_Categorias.js"></script>
    </body>
</html>
