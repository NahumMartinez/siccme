$(document).ready(function () {  
		...
		var p_IdTipoEmple			= $("#id_tipo_emple").val();
		var p_IdEstEmpple			= $("#id_estado_emple").val();
		var p_FeNacimiento			= $("#f_nacimiento").val();
		var p_CodPers				= $("#cod_pers").val();
		var p_IdPersona				= $("#id_persona").val();
		var p_IdPuestoLab			= $("#id_puesto_lab").val();
		var p_Op					= $("#op").val();
		
        var data = "gp_CodEmple="+p_CodEmple+"&gp_FeCreacion="+p_FeCreacion+"&gp_Programa="+p_Programa+"&gp_Usuario="+p_Usuario+"&gp_NumIdentidad="+p_NumIdentidad+"&gp_NomName1="+p_NomName1+"&gp_NomName2="+p_NomName2+"&gp_Apelli1="+p_Apelli1+"&gp_Apelli2="+p_Apelli2+"&gp_Telefono="+p_Telefono+"&gp_Celular="+p_Celular+"&gp_Email="+p_EMail+"&gp_RefDir="+p_RefDir+"&gp_IdTipoEmple="+p_IdTipoEmple+"&gp_IdEstEmple="+p_IdEstEmpple+"&gp_FeNacimiento="+p_FeNacimiento+"&gp_CodPers="+p_CodPers+"&gp_IdPersona="+p_IdPersona+"&gp_IdPuestoLab="+p_IdPuestoLab+"&gp_Op="+p_Op;
		$.ajax({
			type: "POST",
              url: "../../../ctrl/ctrlEmpleados/ctrlEmpleados.php",
              data: data,
              timeout:3000,
              dataType: 'json',
               beforeSend: function () {
              ...
              success: function(response) {
					...
					setTimeout(function () 
				{
					...
					$("#id_tipo_emple").val(response.valor11);
					$("#id_estado_emple").val(response.valor12);
					...
					$("#id_puesto_lab").val(response.valor17);
				...
				$('#cod_pers').val('');
					...
					$('#id_tipo_emple').val(0);
					$('#id_tipo_emple').attr('disabled','-1');
					$('#id_estado_emple').val(0);
					$('#id_estado_emple').attr('disabled','-1');
					$('#f_nacimiento').val('');
					$('#f_nacimiento').attr('disabled','-1');
					$('#id_persona').val(0);
					$('#id_puesto_lab').val(0);
					$('#id_puesto_lab').attr('disabled','-1');
              ...
              success: function(response) {
					...
					setTimeout(function () 
				{
					...
					$('#id_persona').val(0);
                                        ...
                                        $(location).attr('href',"v_mant_empleados.php");
					}, 2000);
				});
