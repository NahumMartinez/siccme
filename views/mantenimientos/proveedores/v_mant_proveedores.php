...
<html>
    <head>
        ...
        <script src="v_valid_Proveedores.js"></script>
		<!-- Jquery UI -->
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="left-side sidebar-offcanvas">
				...
				<li class="active"><a href="#"><i class="fa fa-angle-double-right"></i> Proveedores</a></li>
            ...
            <aside class="right-side">
                ...
                <section class="content" id="content">
                    ...
                    <div class='box box-info'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Consulta de Proveedores <small>Filtro para buscar Proveedores </small></h3>
                                    <!-- tools box -->
                    ...
                    <!-- NMA : FIN -->            
                                ...
                                <!-- NMA : INI Tabla -->								
								<?php include_once("../../../ctrl/ctrlProveedores/ctrlTablaProveedores.php"); ?>
								<!-- NMA : FIN Tabla -->
								
					 <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Ingreso de Proveedores <small>Formulario para Ingreso de Proveedores</small></h3>
                                    
                                    
                                </div><!-- /.box-header -->
                                
                                    
                <!-- Inicio de Creaion de Formulario de Proveedores
                NMA : 01-11-2014 -->
                						
                <!-- Creacion del Formulario de Proveedores -->
                ...
                <legend style="color:#000; border-color:#000"></legend>
                        ...
                        <form method="post" action="#" name="form_Proveedores" id="form_Proveedores" >
                        	<table> <!-- Primera Tabla Datos de Sistemas -->
                            	<tr>
                                	<td><label class="td_1">Codigo :</label></td>
                                	<td><input class="cod" id="cod_proveedor" name="cod_proveedor" type="text" placeholder="Codigo"  maxlength="6" onkeyup="Upper(cod_proveedor);" ></td>
                                </tr>
                            	...
                            	<tr>
                                    ...
                                    <td><input type="hidden" value="t00_Proveedores" name="programa" id="programa"></td>
                                </tr>
							</table>
							<hr>
							...
							<marquee width="100%" height="30" align="bottom">
								...
								<tr>
                                	<td><label class="td_1">Codigo :</label></td>
                                	<td><input class="cod" id="cod_pers" name="cod_pers" type="text" placeholder="Codigo"  maxlength="6" onkeyup="Upper(cod_pers);" disabled><input class="btn btn-warning" type="button" value="Buscar" id="botonbc" name="btnbuscac" accesskey="bs" onclick='BuscarProv();' disabled></td>
							...
							<hr >
							<table>	<!-- Datos del Proveedores -->	
								<tr>
                                	<td><label class="td_1">Tipo Proveedor :</label>
									</td>
                                	<td><SELECT class="combo" name="id_tipo_prov"  id="id_tipo_prov" disabled>
										<option value="0">Seleccione una Opción...</option>
											<?php 
											 include_once("../../../scripts/scr_cargarCombo.php");
												CCombo('t00_tipos','id_tipo','desc_tipo','cod_tipo','%TTP%');
											?>
										</SELECT>
									</td>
									
									<td><label class="td_1">Estado Proveedor :</label>
									</td>
                                	<td><SELECT class="combo" name="id_estado_prov"  id="id_estado_prov" disabled>
										<option value="0">Seleccione una Opción...</option>
											<?php 
											 include_once("../../../scripts/scr_cargarCombo.php");
								...
								<tr>
                                	<td><label class="td_1">Rubro Proveedor :</label>
									</td>
                                	<td><SELECT class="combo" name="id_rubro"  id="id_rubro" disabled>
										<option value="0">Seleccione una Opción...</option>
											<?php 
											 include_once("../../../scripts/scr_cargarCombo.php");
												CCombo('t00_rubros','id_rubro','desc_rubro','cod_rubro','%%');
											?>
										</SELECT>
									</td>
        ...
        <script src="v_ajax_Proveedores.js"></script>
    </body>
</html>
