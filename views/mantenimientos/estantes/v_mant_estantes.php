...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Mantenimiento | Estantes</title>
        ...
        <script src="v_valid_Estantes.js"></script>
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="left-side sidebar-offcanvas">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="#"> ------------------------------------------</a></li>
                                <li><a href="v_mant_localidades.php"><i class="fa fa-angle-double-right"></i> Localidades</a></li>
				...
				<li class="active"><a href="#"><i class="fa fa-angle-double-right"></i> Estantes</a></li>
				<li><a href="#"> ------------------------------------------</a></li>
                ...
                <section class="content" id="content">
                    ...
                    <div class='box box-info'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Consulta de Estantes <small>Filtro para buscar Estantes </small></h3>
                                    <!-- tools box -->
                    ...
                    <!-- NMA : FIN -->            
                            ...
                            <!-- NMA : INI Tabla -->								
								<?php include_once("../../../ctrl/ctrlEstantes/ctrlTablaEstantes.php"); ?>
							<!-- NMA : FIN Tabla -->    
								
					 <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Ingreso de Estantes <small>Formulario para Ingreso de Estantes</small></h3>
                        ...
                        <form method="post" action="#" name="form_Tipos" id="form_Categorias" >
                        	<table>
                            	<tr>
                                	...
                                	<td><input class="cod" id="cod_estant" name="cod_estant" type="text" placeholder="Codigo"  maxlength="6" onkeyup="Upper(cod_estant);" ></td>
                                </tr>
                            	<tr>
                                	<td><label>Nombre :</label></td>
                                	<td><input class="desc" id="desc_estante" name="desc_estante" type="text" placeholder="Introduzca la Descripcion" disabled></td>
                                </tr>
                            	<tr>
                            	...
                            	<tr>
                                    ...
                                    <td><input type="hidden" value="t00_Estantes" name="programa" id="programa"></td>
                                </tr>
								<tr>
                                	<td><label>Almacen :</label>
									</td>
                                	<td><SELECT class="combo" name="id_almacen"  id="id_almacen" disabled>
										<option value="0">Seleccione una Opción...</option>
											<?php 
											 include_once("../../../scripts/scr_cargarCombo.php");
												CCombo('t00_almacenes','id_almacen','nom_almacen','cod_almacen','%%');
											?>
										</SELECT>
									</td>
                                </tr>
								<tr>
                                	<td><label>Num. Filas :</label></td>
                                	<td><input class="num" id="num_filas" name="num_filas" type="text" placeholder="Filas" disabled maxlength="3" ></td>
                                </tr>
								<tr>
                                	<td><label>Num. Columnas :</label></td>
                                	<td><input class="num" id="num_columnas" name="num_columnas" type="text" placeholder="Column." disabled maxlength="3" ></td>
                                </tr>
                            </table>
                            <table>    
                                <tr>
        ...
        <script src="v_ajax_Estantes.js"></script>
    </body>
</html>
