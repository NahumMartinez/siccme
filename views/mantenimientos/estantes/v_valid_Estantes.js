...
//campos		
	...
	f.num_filas.disabled = false;
	f.num_columnas.disabled = false;
	f.id_almacen.disabled = false;
		
	f[0].value = '';
	f[1].value = '';
	f.num_filas.value = '';
	f.num_columnas.value = '';
	f[0].focus();
...
var f = document.form_Tipos;
	...
	f[2].disabled = true;
	f[3].disabled = true;
	f.num_filas.disabled = true;
	f.num_columnas.disabled = true;
	f.id_almacen.disabled = true;
