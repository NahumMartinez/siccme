...
function Incluir(){
var f = document.form_Sucursales;
//campos		
	f[0].disabled = false;
	f[1].disabled = false;
	f[2].disabled = true;
	...
	f.id_loc.disabled = false;
	f.desc_latitud.disabled = false;
	f.desc_longitud.disabled = false;
		
	f[0].value = '';
	f[1].value = '';
	f.desc_latitud.value = '';
	f.desc_longitud.value = '';
	f[0].focus();
...
var f = document.form_Sucursales;
	...
	f.id_loc.disabled = true;
	f.desc_latitud.disabled = true;
	f.desc_longitud.disabled = true;
...
function Eliminar(){
			var f = document.form_Sucursales;
			if(confirm('Desea Eliminar este Sucursal '))
			{
				if(f[0].value == '') 
				{
					alert('Falta Ingresar el Codigo para continuar');
