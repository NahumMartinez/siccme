...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Mantenimiento | Sucursales</title>
        ...
        <script src="v_valid_Sucursales.js"></script>
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="#"><i class="fa fa-angle-double-right"></i> Sucursales</a></li>
            ...
            <aside class="right-side">
                ...
                <section class="content" id="content">
                    ...
                    <div class='box box-info'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Consulta de Sucursales <small>Filtro para buscar Sucursales </small></h3>
                                    <!-- tools box -->
                    ...
                    <!-- NMA : FIN -->            
                                ...
                                <!-- NMA : INI Tabla -->								
								<?php include_once("../../../ctrl/ctrlSucursales/ctrlTablaSucursales.php"); ?>
								<!-- NMA : FIN Tabla -->
								
					 <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Ingreso de Sucursales <small>Formulario para Ingreso de Sucursales</small></h3>
                                    
                                    
                                </div><!-- /.box-header -->
                                
                                    
                <!-- Inicio de Creaion de Formulario de Sucursales
                NMA : 05-10-2014 -->
                						
                <!-- Creacion del Formulario de Sucursales -->
                ...
                <legend style="color:#000; border-color:#000"></legend>
                        ...
                        <form method="post" action="#" name="form_Sucursales" id="form_Sucursales" >
                        	<table>
                            	<tr>
                                	<td><label>Codigo :</label></td>
                                	<td><input class="cod" id="cod_sucursal" name="cod_sucursal" type="text" placeholder="Codigo"  maxlength="6" onkeyup="Upper(cod_sucursal);" ></td>
                                </tr>
                            	<tr>
                                	<td><label>Descripcion :</label></td>
                                	<td><input class="desc" id="desc_sucursal" name="desc_sucursal" type="text" placeholder="Introduzca la Descripcion" disabled></td>
                                </tr>
                            	<tr>
                            	...
                            	<tr>
                                    ...
                                    <td><input type="hidden" value="t00_Sucursales" name="programa" id="programa"></td>
                                </tr>
								<tr>
								...
								<tr>
                                	...
                                	<td><SELECT class="combo" name="id_emple"  id="id_emple" disabled>
										<option value="0">Seleccione una Opción...</option>
											<?php 
											 include_once("../../../scripts/scr_cargarCombo.php");
												CCombo('t00_empleados','id_empleado','nombre_empleado','cod_empleado','%%');
											?>
										</SELECT>
									</td>
                                </tr>
								<tr>
                                	...
                                	<td><input class="coord" id="desc_latitud" name="desc_latitud" type="text" placeholder="Latitud" disabled></td>
                                </tr>
								<tr>
                                	<td><label>Longitud :</label></td>
                                	<td><input class="coord" id="desc_longitud" name="desc_longitud" type="text" placeholder="Longitud" disabled></td>
                                </tr>
                            </table>
                            <table>    
                                <tr>
        ...
        <script src="v_ajax_Sucursales.js"></script>
    </body>
</html>
