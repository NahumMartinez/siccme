...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Mantenimiento | Fincas</title>
        ...
        <script src="v_valid_Fincas.js"></script>
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="left-side sidebar-offcanvas">
				...
				<li><a href="#"> ------------------------------------------</a></li>
                                <li class="active"><a href="v_mant_fincas.php"><i class="fa fa-angle-double-right"></i> Fincas</a></li>
				<li><a href="#"> ------------------------------------------</a></li>
                ...
                <section class="content" id="content">
                    ...
                    <div class='box box-info'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Consulta de Fincas <small>Filtro para buscar Fincas </small></h3>
                                    <!-- tools box -->
                    ...
                    <!-- NMA : FIN -->            
                            ...
                            <!-- NMA : INI Tabla -->								
								<?php include_once("../../../ctrl/ctrlFincas/ctrlTablaFincas.php"); ?>
							<!-- NMA : FIN Tabla -->    
								
					 <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Ingreso de Fincas <small>Formulario para Ingreso de Fincas</small></h3>
                        ...
                        <form method="post" action="#" name="form_Tipos" id="form_Categorias" >
                        	<table>
                            	<tr>
                                	...
                                	<td><input class="cod" id="cod_finca" name="cod_finca" type="text" placeholder="Codigo"  maxlength="6" onkeyup="Upper(cod_finca);" ></td>
                                </tr>
                            	<tr>
                                	<td><label>Nombre Finca :</label></td>
                                	<td><input class="desc" id="desc_finca" name="desc_finca" type="text" placeholder="Introduzca el Nombre" disabled></td>
								...
								<tr>
                                	...
                                	<td><SELECT class="combo" name="id_localidad"  id="id_localidad" disabled>
										<option value="0">Seleccione una Opción...</option>
											<?php 
											 include_once("../../../scripts/scr_cargarCombo.php");
												CCombo('t00_localidades','id_localidad','nombre_localidad','cod_localidad','%%');
											?>
										</SELECT>
									</td>
                                </tr>
							...
							<table>
								<tr>
                                	<td ><label class="td_1">Num. Puerta :</label></td>
                                	<td><input class="num" id="num_puerta" name="num_puerta" type="text" placeholder="Puerta" disabled></td>
									
									<td ><label class="td_1">Num. Bloque :</label></td>
                                	<td><input class="num" id="num_bloque" name="num_bloque" type="text" placeholder="Bloque" disabled></td>
									
									<td ><label class="td_1">Num. Peatonal :</label></td>
                                	<td><input class="num" id="num_paetonal" name="num_paetonal" type="text" placeholder="Peatonal" disabled></td>
									
									<td ><label class="td_1">Num. Calle/Ave :</label></td>
                                	<td><input class="num" id="num_calle" name="num_calle" type="text" placeholder="Calle" disabled></td>
							...
							<table>		
								<tr>
                                	...
                                	<td><textarea class="txtArea" rows="4" cols="50" disabled id="ref_dir" name="ref_dir">
							...
							<table>		
								<tr>
                                	<td ><label class="td_1">Latitud :</label></td>
                                	<td><input class="num" id="latitud" name="latitud" type="text" placeholder="Latitud" disabled></td>
									
									<td ><label class="td_1">Longitud :</label></td>
                                	<td><input class="num" id="longitud" name="longitud" type="text" placeholder="Longitud" disabled></td>
        ...
        <script src="v_ajax_Fincas.js"></script>
    </body>
</html>
