...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Transaccion | Registro de Facturas</title>
	...
	<!-- Tabla Transaccional style -->
        ...
        <script src="v_valid_RegistroFacturas.js"></script>
		<!-- Jquery UI -->
	...
	<div id="div_error">
            <img id="cargador_err" src="../../../img/ajax-loader1.gif" alt="Hola Error" />
            <span id="spam_1"></span>
        </div>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Facturacion  
                        <small>Registro de Facturas </small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
                        <li><a href="#">Facturacion</a></li>
                        <li class="active">Registro de Facturas</li>
                    </ol>
                </section>
		...
		<div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Registro de Facturas <small>Formulario para Registro de Facturas</small></h3>
                                    
                                </div><!-- /.box-header -->
                                
                                    
                <!-- Inicio de Creaion de Formulario de Registro de Facturas
                NMA : 01-04-2015 -->
                						
                <!-- Creacion del Formulario de Registro de Facturas -->
                ...
                <legend style="color:#000; border-color:#000"></legend>
                        ...
                        <form method="post" action="#" name="form_Compras" id="form_Compras" >
                            <a class="btn btn-block btn-social btn-instagram">
                                        <i class="fa fa-group"></i> Datos de Clientes
                                </a><p></p>
                        	<div >
                                    <table>
					<tr>
                                            <td><label class="td_1" style="font-size:16px">Numero : </label></td>
                                            <td><input class="num"  type="text" value="<?php CSecuencial('t00_ventas_enc'); ?>" id="secuencial"  disabled></td>
                                            ...
                                            <td><input type="hidden" value="t00_Ventas_Enc" id="programa"></td>
					...
					<tr>	
                                            <td><label class="td_1">Cliente :</label></td>
                                            <td><input class="num" id="cod_cliente" type="text" maxlength="6" onkeyup="Upper(cod_cliente);" ></td>
                                            				
                                            <td><input type="hidden" value="" id="id_cliente"></td>
						
					</tr>
								
					<tr>
                                            <td><label class="td_1">Nombre Cliente :</label></td>
                                            <td><input class="desc" id="nom_cliente"  type="text" placeholder="Cliente" disabled ></td>
                                            <td><label class="td_1">Apellido :</label></td>
                                            <td><input class="desc" id="apell_cliente"  type="text" placeholder="Apellido" disabled ></td>
					</tr>
                                        
                                        <tr>
                                            <td><label class="td_1">Tipo Cliente :</label></td>
                                            <td><input class="desc" id="tipo_cliente"  type="text" placeholder="Tipo Cliente" disabled ></td>
                                            
                                        </tr>
                                             
                                        <tr>
                                            <!-- Boton Modal de Almacenes -->
                                            <td><a class="btn btn-block btn-primary" style=" width:80px" id="btnShowCliente"  data-toggle="modal" data-target="#compose-modal">Buscar
                                    ...
                                    <hr>   
                                    <a class="btn btn-block btn-social btn-instagram">
                                        <i class="fa fa-shopping-cart"></i>Detalle de la Factura
                                    </a><p></p>
                                    <table>  
                                            <tr>
                                                    ...
                                                    <td><input class="num" id="cant_prod" name="cant_prod" type="number" placeholder="Cant" min="1" max="100" maxlength="3" value="1"></td>
                                                    ...
                                                    <td><input type="hidden" value="" name="op_corr" id="op_corr"></td>
                                            </tr>
                                    </table></div>
							
                                    <hr>
							
			    <!-- Tabla de Registro de Detalle de la Factura -->
			...
			<hr>
                            <table> <!-- Botones Tabla -->   
                                <tr>
                                    ...
                                    <td><a class="btn btn-success" id="botong" name="botong" onclick='Guardar();' style=" width:85px"  >Guardar
                ...
                <!-- Final de Creaion de Formulario de Registro de Facturas
                NMA : 03-05-2015 -->
                </div><!-- /.box-body -->
			...
			<!-- COMPOSE MESSAGE MODAL / Clientes -->
                        <div class="modal fade" id="compose-modal" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog" style=" width:700px">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title"><i class="fa fa-fw fa-truck"></i> Datos de Cliente</h4>
                                    </div>
                                    <form action="#" method="post" id="form_BuscaCliente">
                                        <div class="modal-body">
                                            <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input class="num" id="cod_cliente_1" type="text" maxlength="6" onkeyup="Upper(cod_cliente_1);" >
                                                        </td>
                                                        <td><input type="hidden" value="0" id="id_cliente_1"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <input class="desc" type="text" id="nom_cliente_1" value="" disabled />
                                                        </td>
                                                        <td>
                                                            <label class="td_2" style="font-size:14px" >Apellio :</label>
                                                        </td>
                                                        <td>
                                                            <input  class="desc" type="text" id="apell_cliente_1" value="" disabled />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <label class="td_2" style="font-size:14px" >Tipo :</label>
                                                        </td>
                                                        <td>
                                                            <input  class="desc" type="text" id="tipo_cliente_1" value="" disabled />
                                                        </td>
                                                        <td>
                                                            <label class="td_2" style="font-size:14px" >Estado :</label>
                                                        </td>
                                                        <td>
                                                            <input class="desc" type="text" id="estado_cliente_1" value="" disabled />
                                                        </td>
                                                        
                                                        <td><input type="hidden" value="buscaCliente" id="op1" name="op1"></td>
                                                    </tr>
                                            ...
                                            <table>
                                                <tr>
                                                    <td><label class="td_2" style="font-size:14px">Direccion :</label></td>
                                                    <td><textarea class="textbox" rows="4" cols="70" id="ref_dir_1" disabled></textarea></td>
                                                </tr>
                                            </table>
                                        ...
                                        <div class="modal-footer clearfix">
                                            ...
                                            <button type="button" id="btnBuscaCliente" class="btn btn-primary pull-left" ><i class="fa fa-refresh"></i> Buscar</button>
        ...
        <script src="v_ajax_RegistroFacturas.js"></script>
        <script src="v_ajax_BuscaClientes.js"></script>
