...
//campos		
	...
	f.id_tipo_emple.disabled = false;
	f.id_estado_emple.disabled = false;
	f.id_persona.disabled = false;
	f.id_puesto_lab.disabled = false;
...
var f = document.form_Empleados;
	...
	f.id_tipo_emple.disabled = true;
	f.id_estado_emple.disabled = true;
	f.id_persona.disabled = true;
	f.id_puesto_lab.disabled = true;
...
function Guardar(){
			...
			if(f[0].value == '') 
			{
				...
				alert('Falta Ingresar el Codigo de Empleado, para continuar');
				f.cod_pers.focus();
				return;
