...
<html>
    <head>
        ...
        <script src="v_valid_Producto.js"></script>
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="left-side sidebar-offcanvas">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="../../mantenimientos/tipos_productos/v_mant_tipos_productos.php"><i class="fa fa-angle-double-right"></i> Tipos de Productos</a></li>
                                <li><a href="#"> ------------------------------------------</a></li>
				...
				<li><a href="#"> ------------------------------------------</a></li>
                                <li><a href="../../mantenimientos/fincas/v_mant_fincas.php"><i class="fa fa-angle-double-right"></i> Fincas</a></li>
				<li><a href="#"> ------------------------------------------</a></li>
				...
				<li><a href="../../mantenimientos/proveedores/v_mant_proveedores.php"><i class="fa fa-angle-double-right"></i> Proveedores</a></li>
                        ...
                        <li class="treeview  active">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="#"><i class="fa fa-angle-double-right"></i> Productos</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="../../mantenimientos/ingreso_productos/v_mant_ingresoproductos.php"><i class="fa fa-angle-double-right"></i> Ingreso de Productos</a></li>
            ...
            <aside class="right-side">
                ...
                <section class="content" id="content">
                    ...
                    <div class='box box-info'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Consulta de Productos <small>Filtro para buscar Productos </small></h3>
                                    <!-- tools box -->
                    ...
                    <!-- NMA : FIN -->            
                            ...
                            <table>
                                <tr>
                                    <td><a class="btn btn-success" id="btnActConsulta" name="btnAceptarCompra" onclick='actConsulta();' style=" width:105px"  >Actualizar
				...
				<?php include_once("../../../ctrl/ctrlConsultaProductos/ctrlTablaConsultaProducto.php"); ?>
			    <!-- NMA : FIN Tabla -->    
        ...
        <script src="v_ajax_Productos.js"></script>
    </body>
</html>
