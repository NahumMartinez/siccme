...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Compras | Devolucion de Mercaderias</title>
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Compras  
                        <small>Devoluciones de Mercaderias </small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
                        <li><a href="#">Compras</a></li>
                        <li class="active">Devoluciones de Mercaderias </li>
                    </ol>
                </section>
                    ...
                    <div class='box box-info'>
					 ...
					 <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Devoluciones de Mercaderias <small>Formulario para Devoluciones de Mercaderias </small></h3>
                                    
                                    
                                </div><!-- /.box-header -->
                                
                                    
                <!-- Inicio de Creaion de Formulario de Devoluciones
                NMA : 01-11-2014 -->
		...
		<p id='alert_success' class='text-correcto visible'></p>
			    ...
			    <!-- Custom Tabs // Tabs para los Datos Generales y el Detalle de la Compra -->
                            <a class="btn btn-block btn-social btn-instagram">
                                    <i class="fa fa-shopping-cart"></i>Datos de Compra / Detalle de la Compra
                            </a><p></p>
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#tab_1" data-toggle="tab"><i class="fa fa-home"></i> Datos de Compra</a></li>
			    ...
			    <BR>
                            <table> <!-- Botones Tabla -->   
                                <tr>
                                    ...
                                    <td><a class="btn btn-danger" id="btnCancelCompra" name="btnCancelCompra" style=" width:110px">Devolucion
        ...
        <script src="v_ajax_DevolucionesCompras.js"></script>
        <script src="v_ajax_BuscarCompra.js"></script>
        <script src="v_ajax_BuscarAlmacen.js"></script>
        <script src="v_valid_DevolucionesCompras.js"></script>
