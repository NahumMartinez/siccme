...
/**
  ...
  **/ 
  ...
  class clsClientes{
	...
	// INI.
	public function __construct($cod_cliente, $f_creacion, $programa, $nombre_usuario, $id_sexo, $id_est_civil, $id_est_per, $id_munic, $num_identidad, $num_rtn, $num_pas, $nom_name1, $nom_name2, $apell_1, $apell_2, $telefono, $celular, $email, $skype, $facebook, $twitter, $ref_dir, $id_tipo_cli, $id_cond_fiscal, $id_est_cli, $f_nacimiento){
	...
	public function buscar(){
		...
		$sql = "select p.*,c.id_tipo_cliente tipo_cli, c.id_estado_cliente est_cli 
				from t00_personas p, t00_clientes c, t00_municipios m, 
					 t00_sexo s, t00_estados es, t00_estado_civil ec, t00_tipos t 
				where (p.cod_persona = '$this->cod_cliente') 
		...
		$datos_encontrados = $objDatos->filtro($sql);
			...
			{
				$this->cod_cliente 			= $columna['cod_persona'];
				...
				$this->id_tipo_cli	   		= $columna['tipo_cli']; 	// Datos del Cliente
				$this->id_cond_fiscal  		= $columna['id_tipo_persona'];
				$this->id_est_cli  			= $columna['est_cli']; 		// Datos del Cliente
	...
	{
		$objDatos = new clsDatos();
		$sql = "delete from t00_personas where cod_persona = '$this->cod_cliente' ";
